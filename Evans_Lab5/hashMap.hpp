 ...
 *  Author: Emily Evans
 *  This document contains code provided by Professor Yarrington for lab 5 on hash maps
 */
...
public:
	...
	int getClosestPrime(); // I used a binary search on an array of prime numbers to find the closest prime to
